    'M16П2A50B50T21','M16П2A50B60T21','M16П2A50B70T21','M16П2A50B80T21'
  );
  ...
  (
    'M16П2A40B70C12T01','M16П2A40B70C22T01','M16П2A40B80C12T01','M16П2A40B80C22T01',
    'M16П2A40B30C41T05'
  );

  testStringsMPIU31_2_2:array[1..2] of string=
  (
    'M16П2A40B30C70D12T11','M16П2A40B30C70D22T11'
  );

  testStringsMPIU31_3_2:array[1..5] of string=
  (
    'M16П2A80T22P01','M16П2A80T22P02','M16П2A40B11T21','M16П2A40B40T21','M16П2A40B21T21'
  );

  //41 2 прогр.
  testStringsMPIU41_1_2:array[1..11] of string=
  (
    'M16П1A30B21T01','M16П1A30B70T01','M16П1A10B31T01','M16П1A30B80T01',
    'M16П1A10B20T01','M16П1A10B80C22T01','M16П1A10B1101','M16П1A10B40C1105',
    'M16П1A10B40C41T05','M16П1A10B40C21T05','M16П1A10B40C31T05'
  );

  testStringsMPIU41_2_2:array[1..4] of string=
  (
    'M16П1A10B80C10T11','M16П1A10B80C30T11','M16П1A10B80C50T11','M16П1A10B80C70T11'
  );

  testStringsMPIU41_3_2:array[1..5] of string=
  (
    'M16П1A21T22P01','M16П1A21T22P02','M16П1A30B30T21','M16П1A30B40T21','M1612A30B11T21'
  );

  //32 2 прогр.
  testStringsMPIU32_1_2:array[1..10] of string=
  (
    'M16П2A11T22P01','M16П2A11T22P02','M16П2A21T22P01','M16П2A21T22P01',
    'M16П2A70B20T21','M16П2A70B31T21','M16П2A70B40T21','M16П2A70B60T21',
    'M16П2A70B11T21','M16П2A70B80T21'
  );
  ...
  startBVktime:Integer=0;  //нет присваивания 
...
begin
  ...
  begin
    ...
    begin
      form1.mmoTestResult.Lines.Add('Канал: '+intTostr(i+1)+' Значение на канале: '+floatToStrF(chValOm,ffFixed,5,4)+' Ом '+' НОРМА');
    end
    else
    begin
      form1.mmoTestResult.Lines.Add('Канал: '+intTostr(i+1)+' Значение на канале: '+floatToStrF(chValOm,ffFixed,5,4)+' Ом '+' !!! НЕ НОРМА !!!');
      bool:=false;
    end;
  end;
...
begin
  ...
  startWSaz:=False;
  i:=1;
  form1.mmoTestResult.Lines.Add('Проверка приема данных с прибора АБ САЗ');
  form1.mmoTestResult.Lines.Add('');
  Form1.tmrTestSaz.Enabled:=True;

  //ждем пока не заполним массив САЗ
  ...
  if (bool) then
  begin
    Form1.mmoTestResult.Lines.Add('Проверка приема данных с прибора АБ САЗ: НОРМА');
  end
  else
  begin
    Form1.mmoTestResult.Lines.Add('Проверка приема данных с прибора АБ САЗ: !!! НЕ НОРМА !!!');
    allTestFlag:=False;
  end;
  form1.mmoTestResult.Lines.Add('');
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      //перестыковка 41_X2,41_X3 на 32_X2,32_X3
      ret :=Application.MessageBox(PAnsiChar('Перестыкуйте на адаптере кабели 41_X2,41_X3 на кабели 32_X2,32_X3 и нажмите ОК для продолжения проверки'),PAnsiChar('Перестыковка кабелей'), MB_OK);
      if ret=IDOK then
      begin
        //32
        Form1.mmoTestResult.Lines.Add('ПРОВЕРКА МПИУ 32');
        Form1.mmoTestResult.Lines.Add('');
        //M16П2A50B50T21 {A=5 ПА=2}, M16П2A50B60T21 {A=6 ПА=0}
        form1.PageControl1.ActivePageIndex:=1;
        adrTestNum:=13;
        //выставялем адреса
        testNeedsAdrF;
        ...
        begin
          flagMPIU32:=false;
          Form1.mmoTestResult.Lines.Add('Проверка приема данных с прибора МПИУ32: !!! НЕ НОРМА !!!');
          allTestFlag:=False;
        end;       
        testMpiuFlag:=false;
        Form1.mmoTestResult.Lines.Add('');
